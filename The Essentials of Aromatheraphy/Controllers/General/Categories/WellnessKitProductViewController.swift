//
//  WellnessKitProductViewController.swift
...
class WellnessKitProductViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    private let products = ProductCaller.wellnessBlendKit()
    ...
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        return "Wellness Essential Oil Blend Kit"
    }
